...
function runBaseTests() {
  px_datetime_common_1 = document.getElementById('px_datetime_common_1');

  suite('Base Automation Tests for px-datetime-common', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-datetime-common fixture is created', function() {
      assert.isTrue(document.getElementById('px_datetime_common_1') !== null);
    });
